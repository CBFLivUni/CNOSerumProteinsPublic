...
Convert to .R script with:

knitr::purl(input = here::here("07_biomarkerSelection.qmd"), output = here::here("07_biomarkerSelection.R"), documentation = 0)
...
### Source job-specific biomarkers

May need to manually create an empty version of this file
...
### Ensure parameters are of right time

This is mainly for numeric/boolean parameters, characters should be fine
...
#### Filter data to exclude desired groups
...
### Retain only proteins with no NAs
...
### Filter chosen protein set

FC threshold on hits - treat method? FC for CNO vs others.
...
Exclude backwards selection? 

Try boruta?

If ith lambda convergence issue - likely too small choice of lambda, try with a larger minimum value
...
### Loop over models and add attributes
