...
knitr::purl(input = here::here("06_differentialAbundance.qmd"), output = here::here("06_differentialAbundance.R"), documentation = 0)
...
Unhash the below when compiling to R script. See last chunk as this should be commented as well.
...
### Normalise train data after split

Idea is that this stops data leakage
...
### Covariate/Factor relationships
...
#### Define alt model fitting method
...
### Test model formulations by AIC
...
#### All Dresden Samples, Considering Date
...
### Plot sample distributions of samples with date
...
#### ANOVA-like across all conditions

##### Generate formula and design

Can't include Condition:Sex term for liverpool-only due to confounding
...
All dreseden hits seem consistent with Vanderbilt-excluding and all sample child comparisons.
...
#### Run PCA on Dresden sig proteins
...
## Consideration of site correlation

### Limma

Here we model site with duplicate correlation.
