...
dir.create(here::here(diaDir, "imputation", "QC", "childSamples"), recursive=TRUE, showWarnings=FALSE)
...
for (i in 1:9) {
  ...
  # Save
  ggsave(here::here(diaDir, "imputation", "QC", "childSamples", paste0("PCA_biplot.pc",i,"to",i+1,".colByPlate.bPCAImputed_crossSectional_childSamples.png")), plate_plt, width=6000, height=4000, units="px")
  ggsave(here::here(diaDir, "imputation", "QC", "childSamples", paste0("PCA_biplot.pc",i,"to",i+1,".colByPlateRow.bPCAImputed_crossSectional_childSamples.png")), row_plt, width=6000, height=4000, units="px")
  ggsave(here::here(diaDir, "imputation", "QC", "childSamples", paste0("PCA_biplot.pc",i,"to",i+1,".colByPlateColumn.bPCAImputed_crossSectional_childSamples.png")), col_plt, width=6000, height=4000, units="px")
  ggsave(here::here(diaDir, "imputation", "QC", "childSamples", paste0("PCA_biplot.pc",i,"to",i+1,".colByCondition.bPCAImputed_crossSectional_childSamples.png")), cond_plt, width=6000, height=4000, units="px")
  ggsave(here::here(diaDir, "imputation", "QC", "childSamples", paste0("PCA_biplot.pc",i,"to",i+1,".colBySex.bPCAImputed_crossSectional_childSamples.png")), sex_plt, width=6000, height=4000, units="px")
  ggsave(here::here(diaDir, "imputation", "QC", "childSamples", paste0("PCA_biplot.pc",i,"to",i+1,".colByAge.bPCAImputed_crossSectional_childSamples.png")), age_plt, width=6000, height=4000, units="px")
